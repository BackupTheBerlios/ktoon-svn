...
void Import::slotAccept()
{
        ...
        case 1:
	{
        ...
        case 2:
	{
            QString fn = QFileDialog::getOpenFileName( "projects/lbr/", "Graphic Library ( *.lbr )", this,
        ...
        case 3:
	{
            QString fn = QFileDialog::getOpenFileName( "projects/cpl/", "Palette ( *.cpl )", this,
        ...
        case 4:
	{
            QString fn = QFileDialog::getOpenFileName( "projects/bru/", "Brushes File ( *.bru )", this,
