...
About::About( QWidget *parent ) : QTabDialog( parent )
{
    ...
    credits_pixmap.load( "src/ani/credits/credits-image.png" );
    credits -> setPixmap( credits_pixmap );

    QFile credits_file( "src/ani/credits/credits-text.txt" );
    ...
    file_id2 = 1;
    ack_pixmap = QPixmap();
    ack_pixmap.load( "src/ani/ack/ack-image1.png", "PNG" );
    ...
    toonka_pixmap = QPixmap( "src/ani/toonka.jpg" );
    ...
    laboratoon_pixmap = QPixmap( "src/ani/laboratoon.jpg" );
...
void About::slotDisplayAcknowledgementsPixmap()
{
    ...
    png_file_name = QString( "src/ani/ack/ack-image" + QString::number( file_id2 ) + ".png" );
