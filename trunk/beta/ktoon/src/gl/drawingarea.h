...
class DrawingArea : public GLControl
{
    ...
    protected:
        ...
        */
        Color *grabColor( const QPoint & pick_point );
        /**
        ...
        */
        ...
        QPtrList<GLGraphicComponent> current_graphic_list;
        
        QPtrList<GLGraphicComponent> history_graphic_list;
        ...
        QPtrList<GLGraphicComponent> previous_onion_skin_1;
        QPtrList<GLGraphicComponent> previous_onion_skin_2;
        QPtrList<GLGraphicComponent> previous_onion_skin_3;
    
        //Variables related to the next onion skin
        QPtrList<GLGraphicComponent> next_onion_skin_1;
        QPtrList<GLGraphicComponent> next_onion_skin_2;
        QPtrList<GLGraphicComponent> next_onion_skin_3;
