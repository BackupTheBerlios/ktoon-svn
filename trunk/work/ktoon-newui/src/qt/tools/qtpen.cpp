...
QtPen::QtPen( QCanvas *canvas ) : QCanvasPolygonalItem( canvas ), point_array( 0 ), control_points( 0 )
{
...
QPointArray QtPen::areaPoints() const
{
...
void QtPen::drawShape( QPainter &painter )
{
	...
	QPointArray translated_control_points( control_points.count() );
