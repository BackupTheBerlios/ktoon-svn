	...
	switch (element)
	{
		...
		case PE_PanelButtonCommand:
		{
			...
			if (button)
			{
				...
				if (down && goodSize)
				{
					left = cached(":dwaitstyle/images/button_pressed_cap_left.png", option->palette.color(QPalette::Background));
					
					right = cached(":dwaitstyle/images/button_pressed_cap_right.png", option->palette.color(QPalette::Background));
					mid = cached(":dwaitstyle/images/button_pressed_stretch.png", option->palette.color(QPalette::Background));
				} 
				else if (goodSize)
				{
					left = cached(":dwaitstyle/images/button_normal_cap_left.png", option->palette.color(QPalette::Background));
					right = cached(":dwaitstyle/images/button_normal_cap_right.png", option->palette.color(QPalette::Background));
					mid = cached(":dwaitstyle/images/button_normal_stretch.png", option->palette.color(QPalette::Background));
				}
		...
		case PE_FrameGroupBox:
		{
			...
			if (group)
			{
				...
				QPixmap titleStretch = cached(":dwaitstyle/images/title_stretch.png", option->palette.color(QPalette::Background));
				QPixmap topLeft = cached(":dwaitstyle/images/groupframe_topleft.png", option->palette.color(QPalette::Background));
				QPixmap topRight = cached(":dwaitstyle/images/groupframe_topright.png", option->palette.color(QPalette::Background));
				QPixmap bottomLeft = cached(":dwaitstyle/images/groupframe_bottom_left.png", option->palette.color(QPalette::Background));
				QPixmap bottomRight = cached(":dwaitstyle/images/groupframe_bottom_right.png", option->palette.color(QPalette::Background));
				QPixmap leftStretch = cached(":dwaitstyle/images/groupframe_left_stretch.png", option->palette.color(QPalette::Background));
				QPixmap topStretch = cached(":dwaitstyle/images/groupframe_top_stretch.png", option->palette.color(QPalette::Background));
				QPixmap rightStretch = cached(":dwaitstyle/images/groupframe_right_stretch.png", option->palette.color(QPalette::Background));
				QPixmap bottomStretch = cached(":dwaitstyle/images/groupframe_bottom_stretch.png", option->palette.color(QPalette::Background));
		...
		case CC_Slider:
		{
			if (const QStyleOptionSlider *slider = qstyleoption_cast<const QStyleOptionSlider *>(option))
			{
				...
				if ((option->subControls & SC_SliderGroove) && groove.isValid()) {
					QPixmap grv = cached(":dwaitstyle/images/slider_bar.png", option->palette.color(QPalette::Background));
					painter->drawPixmap(QRect(groove.x() + 5, groove.y(),
							groove.width() - 10, grv.height()),
					grv);
				}
				if ((option->subControls & SC_SliderHandle) && handle.isValid()) {
					QPixmap hndl = cached(":dwaitstyle/images/slider_thumb_on.png", option->palette.color(QPalette::Background));
		...
		case CC_GroupBox:
		{
			...
			if (groupBox)
			{
				...
				if (groupBox->subControls & SC_GroupBoxLabel)
				{
					...
					QPixmap titleLeft = cached(":dwaitstyle/images/title_cap_left.png", option->palette.color(QPalette::Background));
					QPixmap titleRight = cached(":dwaitstyle/images/title_cap_right.png", option->palette.color(QPalette::Background));
					QPixmap titleStretch = cached(":dwaitstyle/images/title_stretch.png", option->palette.color(QPalette::Background));
