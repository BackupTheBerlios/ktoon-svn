	...
	: KTModuleWidgetBase(parent, "Tools")
{
	...
	menu_button_selection = new Q3PopupMenu( this );
	...
	menu_button_draw = new Q3PopupMenu( this );
	...
	menu_button_fill = new Q3PopupMenu( this );
	...
	menu_button_eraser = new Q3PopupMenu( this );
	...
	menu_button_view = new Q3PopupMenu( this );
