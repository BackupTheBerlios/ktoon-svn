...
DrawingArea::DrawingArea( QWidget *parent, const char *name, Qt::WFlags f ) : GLControl( parent, name, 0, f | Qt::WDestructiveClose), rotation_x( 0.0 ), rotation_y( 0.0 ), rotation_z( 0.0 ), translation_x( 0.0 ), translation_y( 0.0 ), translation_z( -10.0 ), scale_x( 1.0 ), scale_y( 1.0 ), scale_z( 1.0 )
{
...
Q3PtrList<GLGraphicComponent> DrawingArea::graphicList() const
{
	return graphic_list;
}
