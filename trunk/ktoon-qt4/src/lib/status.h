...
class Status : public QObject
{
	public:
		...
		*/
		void setRenderKeyframes( Q3PtrList<KeyFrame> frames );
		/**
...
// 		ILayer *currentILayer();
		...
		*/
		Q3PtrList<KeyFrame> renderKeyframes() const;
		/**
...
// 		ILayer *m_currentILayer;
		...
		Q3PtrList<KeyFrame> render_camera_frames;
		QColor current_background_color, current_grid_color, current_ntsc_color;
		
		Document *m_document;
#ifndef NO_OPENGL
		QPointer<DrawingArea> m_currentDrawingArea;
#else
		QPointer<DrawingAreaQt> m_currentDrawingArea;
#endif
};
