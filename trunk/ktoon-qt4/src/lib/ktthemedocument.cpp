...
KTThemeDocument::KTThemeDocument() : QDomDocument()
{
	QDomProcessingInstruction header = this->createProcessingInstruction("xml","version=\"1.0\" encoding=\"UTF-8\"");
	this->appendChild(header);
	
	QDomElement root = createElement( "KTTheme" );
	
	appendChild( root );
}

KTThemeDocument::KTThemeDocument(const QString &name, const QString &version) : QDomDocument()
{
	QDomProcessingInstruction header = this->createProcessingInstruction("xml","version=\"1.0\" encoding=\"UTF-8\"");
	this->appendChild(header);
...
KTThemeDocument::~KTThemeDocument()
{
}

void KTThemeDocument::addGeneralSection(ThemeKey tk)
{
...
void KTThemeDocument::addEffectsSection(ThemeKey tk)		
{
...
void KTThemeDocument::addSelections(ThemeKey tk)
{
...
void KTThemeDocument::addTextEffect(ThemeKey tk)
{
