...
KTSqueezeLabel::~KTSqueezeLabel()
{
}

void KTSqueezeLabel::squeezeText()
{
...
void KTSqueezeLabel::resizeEvent( QResizeEvent * )
{
	squeezeText();
}
...
void KTSqueezeLabel::setText( const QString &text ) 
{
	m_text = text;
	squeezeText();
}

QString KTSqueezeLabel::completeText() const
{
	return m_text;
}
