...
KTFlatButton::KTFlatButton(QWidget *parent) : QAbstractButton(parent)
{
	setCheckable(true);
}

KTFlatButton::KTFlatButton(const QString &text, QWidget *parent ) : QAbstractButton(parent)
{
	setText(text);
	setCheckable(true);
}
...
KTFlatButton::~KTFlatButton()
{
}

void KTFlatButton::paintEvent(QPaintEvent *e)
{
