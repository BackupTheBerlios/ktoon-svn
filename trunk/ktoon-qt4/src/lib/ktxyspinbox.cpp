...
KTXYSpinBox::KTXYSpinBox(const QString &title, QWidget *parent) : QGroupBox(title, parent), m_modifyTogether(true)
{
...
KTXYSpinBox::~KTXYSpinBox()
{
}


void KTXYSpinBox::updateXValue(double v)
{
...
void KTXYSpinBox::updateYValue(double v)
{
...
void KTXYSpinBox::setMinimum ( double min)
{
	m_x->setMinimum(min);
	m_y->setMinimum(min);
}

void KTXYSpinBox::setMaximum ( double max)
{
	m_x->setMaximum(max);
	m_y->setMaximum(max);
}
