...
void GLPen::setPoints( Q3PtrList<QPoint> _points )
{
    points = _points;
}

void GLPen::setBezier( Q3PtrList<QPoint> _bezier )
{
    bezier = _bezier;
}
...
Q3PtrList<QPoint> GLPen::getPoints() const
{
    return points;
}

Q3PtrList<QPoint> GLPen::getBezier() const
{
    return bezier;
}
