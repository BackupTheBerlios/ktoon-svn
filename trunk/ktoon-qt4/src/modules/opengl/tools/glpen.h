...
public:
     ...
     */
    GLPen( QGLWidget *parent, const QPoint & origin, const KTColor & color, const Brush & width, const QPoint & end );
    /**
     ...
     */
    Q3PtrList<QPoint> getBezier() const;
    /**
