...
GLPencil::GLPencil( QGLWidget *parent, const QPoint & _origin, const KTColor & _color, const Brush & _width, const QPoint & _end ) : GLGraphicComponent( parent, _origin, _color, _width ), end( _end )
{
  	Q_CHECK_PTR( parent );
...
void GLPencil::setPoints( Q3PtrList<QPoint> _points )
{
    points = _points;
}
...
Q3PtrList<QPoint> GLPencil::getPoints() const
{
    return points;
}
