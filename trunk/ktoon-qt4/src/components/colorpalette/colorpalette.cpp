...
void ColorPalette::setupBlockStandardPalette()
{
	...
	Q3VBox *blockStandardPalette = new Q3VBox(this);
...
void ColorPalette::setupBlockColorMixer()
{
	...
	Q3HBox *lineOrfill = new Q3HBox(this);
	...
	addChild(lineOrfill);
	Q3HBox *colorMixerBlock = new Q3HBox(this);
	addChild(colorMixerBlock);
	Q3VBox *textRGBA = new Q3VBox(colorMixerBlock);
	QString rgba("RGBA");
	...
	Q3VBox *spinsRGBA = new Q3VBox(colorMixerBlock);
	...
	Q3VBox *textHSV= new Q3VBox(colorMixerBlock);
	QString hsv("HSV");
	for(int i  = 0; i < 3; i++)
	{
	...
	Q3VBox *spinsHSV= new Q3VBox(colorMixerBlock);
...
{
	//------------ Gradient Block --------------
	Q3HBox *blockGradient = new Q3HBox(this);
	...
	Q3HBox *blockgGradViewer = new Q3HBox(this);
...
void ColorPalette::setupBlockCustomPalette()
{
	...
	Q3HBox *customPaletteH = new Q3HBox(customPaletteV);
...
void ColorPalette::loadCustomColors( Q3PtrList<KTColor> colors )
{
