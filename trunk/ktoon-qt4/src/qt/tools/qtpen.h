 ...
 */
class QtPen : public Q3CanvasPolygonalItem
{
...
private:
    Q3PointArray point_array;
    Q3PointArray control_points;
    Q3ValueList<int> indexes;  //Indicates which points will take place as bezier points
