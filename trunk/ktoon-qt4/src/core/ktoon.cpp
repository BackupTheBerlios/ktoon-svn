...
KToon::KToon() : Q3MainWindow( 0, "KToon", Qt::WDestructiveClose ), document_max_value(1), file_name("")
{
	...
	if ( ! reader.parseXml(&xmlsource))
	{
		...
		for(uint i = 0; i < 6; i++)
		{
			recent_names << "<" + Q3StyleSheet::escape(tr("empty")) + ">";
		}
	}
	else
	{
...
void KToon::createActions()
{
	...
	edit_copy = new Q3Action( icon_copy, tr( "C&opy" ), tr("Ctrl+C"), this);
	...
	edit_paste = new Q3Action( icon_paste, tr( "&Paste" ), tr("Ctrl+V"), this);
	...
	window_drawing_area = new Q3Action ( icon_drawing_area, tr( "&Drawing Area" ), tr("Ctrl+D"), this);
	...
	window_tools = new Q3Action( icon_tools, tr( "&Tools" ), tr("Ctrl+T"), this);
	...
	window_exposure_sheet = new Q3Action( icon_exposure_sheet, tr( "&Exposure Sheet" ), tr("Ctrl+H"), this);
	...
	window_color_palette = new Q3Action( icon_color_palette, tr( "&Color Palette" ), tr("CTRL+P"), this);
	...
	window_brushes = new Q3Action( icon_brushes, tr( "Brushes" ),tr("Ctrl+B") , this);
	...
	window_scenes = new Q3Action( icon_scenes, tr( "Scenes" ), tr("Ctrl+Y"), this);
	...
	window_library = new Q3Action( icon_library, tr( "Library" ), tr("Ctrl+L"), this);
	...
	window_render_camera_preview = new Q3Action( icon_camera_preview, tr( "&Preview Render" ), tr("Ctrl+R"), this);
	...
	window_top_camera_view = new Q3Action( icon_top_camera, tr( "&Top Camera View" ), Qt::CTRL+Qt::Key_Slash, this);
	...
	window_side_camera_view = new Q3Action( QIcon(icon_side_camera), tr( "Si&de Camera View" ), Qt::CTRL+Qt::Key_Asterisk, this);
	...
	window_illustration = new Q3Action( QIcon(icon_illus_mode), tr( "&Illustration Mode" ), tr("F9") , this);
	...
	window_animation = new Q3Action( QIcon(icon_ani_mode), tr( "&Animation Mode" ), tr("F10"), this);
	...
	Q3ActionGroup *gridGroup = new Q3ActionGroup( this );
	gridGroup->setExclusive( true ); 
	
	view_no_grid = new Q3Action( icon_no_grid, tr( "&No Grid" ), QKeySequence(), gridGroup);
	...
	view_grid12 = new Q3Action( icon_grid12, tr( "&12 Field Grid" ), QKeySequence(), gridGroup);
	...
	view_grid16 = new Q3Action( icon_grid16, tr( "&16 Field Grid" ), QKeySequence(), gridGroup);
	...
	view_subgrid = new Q3Action( icon_subgrid, tr( "&Subgrid" ), QKeySequence(), this),
	...
	view_front_back_grid = new Q3Action( icon_front_back_grid, tr( "Grid to Front/Back" ), QKeySequence(), this);
	...
	view_ntsc = new Q3Action( icon_ntsc, tr( "&NTSC Zone" ), QKeySequence(), this);
	...
	view_light_table = new Q3Action( icon_light_table, tr( "&Light Table" ), QKeySequence(), this);
	...
	Q3ActionGroup *viewPreviousGroup = new Q3ActionGroup( this );
	viewPreviousGroup->setExclusive( true );
	
	view_no_previous = new Q3Action( icon_no_previous, tr( "No Previous" ), Qt::Key_1, viewPreviousGroup);
	...
	view_previous = new Q3Action( icon_previous, tr( "Previous One" ), Qt::Key_2, viewPreviousGroup);
	...
	view_previous2 = new Q3Action( icon_previous2, tr( "Previous Two" ), Qt::Key_3, viewPreviousGroup);
	...
	view_previous3 = new Q3Action( icon_previous3, tr( "Previous Three" ), Qt::Key_4, viewPreviousGroup);
	...
	Q3ActionGroup *viewNextGroup = new Q3ActionGroup( this );
	viewNextGroup->setExclusive( true );
	
	
	view_no_next = new Q3Action( icon_no_next, tr( "No Next" ), Qt::CTRL+Qt::Key_1, viewNextGroup);
	...
	view_next = new Q3Action( icon_next, tr( "Next One" ), Qt::CTRL+Qt::Key_2, viewNextGroup);
	...
	view_next2 = new Q3Action( icon_next2, tr( "Next Two" ), Qt::CTRL+Qt::Key_3, viewNextGroup);
	...
	view_next3 = new Q3Action( icon_next3, tr( "Next Three" ), Qt::CTRL+Qt::Key_4, viewNextGroup);
	...
	file_save_as = new Q3Action( tr( "Save &As..." ),QKeySequence(), this);
	...
	file_close = new Q3Action(icon_close, tr( "Cl&ose" ), tr("Ctrl+W"), this);
	file_close->setStatusTip(tr("Closes the active document"));
	
	file_import = new Q3Action(icon_import, tr( "&Import..." ),  tr("Ctrl+I"), this);
	...
	file_export = new Q3Action(icon_export, tr( "&Export..." ),  tr("Ctrl+E"), this);
	...
	file_properties = new Q3Action( tr( "&Properties..." ),  QKeySequence(), this);
	...
	file_exit = new Q3Action(icon_export, tr( "E&xit" ),  tr("Ctrl+Q"), this);
	connect(file_exit, SIGNAL(activated()), this, SLOT(close()));
	file_exit->setStatusTip(tr("Closes the application"));
	
	edit_paste_in_place = new Q3Action( tr(  "Paste &In Place" ),  tr("Ctrl+Shift+V"), this);
	...
	edit_preferences = new Q3Action( tr( "Pr&eferences..." ), QKeySequence(), this);
	...
	view_zoom_in = new Q3Action(icon_zoom_in, tr( "Zoom &In" ),tr("Ctrl++") , this);
	...
	view_zoom_out = new Q3Action(icon_zoom_out, tr( "Zoom &Out" ),tr("Ctrl+-") , this);
	...
	view_fit = new Q3Action(icon_fit, tr( "&Fit" ), QKeySequence(), this);
	connect(view_fit, SIGNAL(activated()), this, SLOT( slotFit()));
	view_fit->setStatusTip(tr("Fits the grid into the drawing area"));
	
	view_rotate_clockwise = new Q3Action( tr( "Rotate &Clockwise" ), tr("V"), this);
	...
	view_rotate_counterclockwise = new Q3Action( tr( "Rotate Counterclock&wise" ), tr("C"), this);
	...
	view_restore_rotation = new Q3Action( tr( "&Restore Rotation" ), tr("Shift+C"), this);
	...
	insert_layer = new Q3Action( tr( "&Layer" ), QKeySequence(), this);
	...
	insert_frame = new Q3Action( tr( "&Frame" ), tr("F5"), this);
	...
	insert_remove_frame = new Q3Action( tr( "&Remove Frame" ), tr("Shift+F5"), this);
	...
	insert_keyframe = new Q3Action( tr( "&KeyFrame" ), tr("F6"), this);
	...
	insert_scene = new Q3Action( tr( "&Scene" ), QKeySequence(), this);
	insert_scene->setStatusTip(tr("Inserts a new scene"));
	
	insert_remove_scene = new Q3Action( tr( "Re&move  Scene" ), QKeySequence(), this);
	insert_remove_scene->setStatusTip(tr("Removes the selected scene"));

	tools_selection = new Q3ActionGroup( this );
	...
	tools_normal_selection = new Q3Action(icon_selection, tr( "Normal &Selection" ), tr("S"), tools_selection);
	...
	tools_contour_selection = new Q3Action(icon_nodes, tr( "Con&tour Selection" ), tr("T"), tools_selection);
	...
	tools_contour_fill = new Q3Action(icon_contour_fill, tr( "&Contour Fill" ), tr("Ctrl+F"), tools_fills);
	...
	tools_hand = new Q3Action(icon_hand, tr( "&Hand" ), tr("H"), tools_view);
	connect(tools_hand, SIGNAL(activated()), this, SLOT( slotHand()));
	tools_hand->setStatusTip(tr("Activates the Hand tool"));
	
	tools_group = new Q3Action(icon_group, tr( "&Group" ), QKeySequence(), this);
	...
	tools_bring_front = new Q3Action(icon_bring_to_front, tr( "&Bring to Front" ), Qt::CTRL+Qt::SHIFT+Qt::Key_Up, tools_order);
	...
	tools_send_back = new Q3Action(icon_send_to_back, tr( "&Send to Back" ), Qt::CTRL+Qt::SHIFT+Qt::Key_Down, tools_order);
	...
	tools_one_step_forward = new Q3Action(icon_one_forward, tr( "One Step &Forward" ), Qt::CTRL+Qt::Key_Up, tools_order);
	...
	tools_one_step_backward = new Q3Action(icon_one_backward, tr( "One Step B&ackward" ), Qt::CTRL+Qt::Key_Down, tools_order);
	...
	tools_align = new Q3ActionGroup( this );
	...
	tools_left = new Q3Action(icon_align_l, tr( "&Left" ),  QKeySequence(), tools_align);
	...
	tools_center_vertically = new Q3Action(icon_align_cv, tr( "&Center Vertically" ),  QKeySequence(), tools_align);
	...
	tools_right = new Q3Action(icon_align_r, tr( "&Right" ),  QKeySequence(), tools_align);
	...
	tools_top = new Q3Action(icon_align_t, tr( "&Top" ), QKeySequence(), tools_align);
	connect(tools_top, SIGNAL(activated()), this, SLOT( slotAlignTop()));
	tools_top->setStatusTip(tr("Aligns the selected object to the top"));
	
	tools_center_horizontally = new Q3Action(icon_align_ch, tr( "Center &Horizontally" ),  QKeySequence(), tools_align);
	...
	tools_bottom = new Q3Action(icon_align_b, tr( "&Bottom" ),  QKeySequence(), tools_align);
	...
	tools_transform = new Q3ActionGroup( this );
	...
	tools_flip_horizontally = new Q3Action(tr( "Flip &Horizontally" ),  QKeySequence(), tools_transform);
	...
	tools_flip_vertically = new Q3Action(tr( "Flip &Vertically" ),  QKeySequence(), tools_transform );
	...
	tools_rotate_cw90 = new Q3Action(tr( "&Rotate 90 CW" ),  QKeySequence(), tools_transform);
	...
	tools_rotate_ccw90 = new Q3Action(tr( "&Rotate 90 CCW" ),  QKeySequence(), tools_transform);
	...
	tools_rotate180 = new Q3Action(tr( "&Rotate &180" ),  QKeySequence(), tools_transform);
	...
	tools_perspective = new Q3Action(QIcon(icon_perspective), tr( "&Perspective" ),  QKeySequence(), tools_transform);
	...
	control_step_forward = new Q3Action(tr( "Step &Forward" ),  Qt::Key_Period, this);
	...
	control_step_backward = new Q3Action(tr( "Step &Backward" ), Qt::Key_Comma, this);
	...
	help_contents = new Q3Action(tr( "&Contents" ),  tr("F1"), this);
	...
	help_about = new Q3Action(tr( "&About K-Toon..." ), QKeySequence (), this);
	...
	help_about_qt = new Q3Action(tr( "About &Qt..." ), QKeySequence (), this);
	connect(help_about_qt, SIGNAL(activated()), qApp, SLOT( aboutQt()));
	help_about_qt->setStatusTip(tr("Shows information about Qt"));
	
	help_about_opengl = new Q3Action(tr( "About &OpenGL..." ), QKeySequence (), this);
...
void KToon::setupMenu()
{
	...
	open_recent = new Q3PopupMenu( this );
	...
	onion_skin = new Q3PopupMenu( this );
	...
	id_window_timeline = window -> insertItem( icon_time_line, tr( "T&imeline" ), this, SLOT( slotWindowTimeline() ), tr("CTRL+K") );
...
void KToon::loadLibrary( const QString &file_name, bool from_load )
{
	...
	if ( !library_file.open( QIODevice::ReadOnly ) )
	{
...
void KToon::loadPalette( const QString &file_name, bool from_load )
{
	...
	if ( !palette_file.open( QIODevice::ReadOnly ) )
	{
...
void KToon::loadBrushes( const QString &file_name, bool from_load )
{
	...
	if ( !brushes_file.open( QIODevice::ReadOnly ) )
	{
			...
			while ( !n_layer.isNull() )
			{
				...
				try {
					...
					while ( !n_keyframe.isNull() )
					{
						...
						Q3PtrList<GLGraphicComponent> graphics;
...
// 	std::cout << "Creating GUI" << std::endl;
	...
	Q3PtrList<KTColor> custom_colors = KTStatus->currentDocument()->getPalette() -> getColors();
	color_palette_dialog -> enableCustomPalette( true );
