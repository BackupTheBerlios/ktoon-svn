...
KTLayerManager::KTLayerManager(QWidget *parent) : QVBox(parent, "KTLayerManager"), m_currentTime(0.0), m_totalTime(0.04), m_allSelected(false), m_allVisible(true), m_allLock(false)
{
	KTINIT;
	
	layout()->setAlignment(Qt::AlignTop);
	
	m_utilsInTop = new QHButtonGroup( this );
	...
	m_utilsInBottom = new QHButtonGroup( this );
