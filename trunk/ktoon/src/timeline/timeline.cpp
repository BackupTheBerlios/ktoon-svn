...
Timeline::Timeline( QWidget *parent, WFlags style, QPopupMenu *in_assigned_menu, int id_assigned_item, QToolButton *assig_tb_button ) : QDialog(parent, "TimeLine") //KTDialogBase( QDockWindow::OutsideDock, parent, "Timeline")
{
    Q_CHECK_PTR( parent );
