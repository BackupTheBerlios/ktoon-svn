...
/**
 * @short A DiButton to place onto the DiButtonBar
 * A QPushButton derivative with a size of a QToolBar. DiButton can be rotated 
...
public:
    ...
    /**Sets the place of a DiButton.*/
    void setPlace(Ideal::Place place);
    /**Sets the mode of a DiButton.*/
    void setMode(Ideal::ButtonMode mode);

    QSize sizeHint() const;
    QSize sizeHint(const QString &text) const;
    
    /**Updates size of a widget. Used after squeezing DiButton's text.*/
    void updateSize();
    
    /**Returns the real (i.e. not squeezed) text of a DiButton.*/
