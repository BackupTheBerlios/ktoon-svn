...
namespace Ideal {
	...
	void DiButton::enterEvent( QEvent* )
	{
	...
	void DiButton::leaveEvent( QEvent* )
	{
	...
	void DiButton::setDescription(const QString &description)
	{
		m_description = description;
		setToolTip(m_description);
	}

	QString DiButton::description() const
	{
		return m_description;
	}
	
	QStyleOptionButton DiButton::styleOption() const
	{
...
// 			opt.state |= QStyle::State_On;
	...
	void DiButton::paintEvent(QPaintEvent *)
	{
		QPainter p(this);
	...
	void DiButton::fixDimensions(Place oldPlace)
	{
		switch (m_place)
		{
			case Ideal::Left:
	...
	QString DiButton::realText() const
	{
		return m_realText;
	}

	void DiButton::setMode(Ideal::ButtonMode mode)
	{
		switch (mode)
		{
			case Text:
	...
	void DiButton::disableIconSet()
	{
		m_haveIcon = false;
		setIcon(QIcon());
	}

	void DiButton::disableText()
	{
		if (text().length() > 0)
		{
			setText("");
	...
	void DiButton::enableText()
	{
		setText(m_realText);
	}
	
	void DiButton::toggleSensibility()
	{
