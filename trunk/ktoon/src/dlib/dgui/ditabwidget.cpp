...
void DiTabWidget::saveSettings()
{
}

QToolButton *DiTabWidget::closeButton() const
{
	return m_closeButton;
}

void DiTabWidget::setFocus(QWidget *w)
{
	if (w)
	{
		w->setFocus();
...
void DiTabWidget::insertTab(QWidget *child, const QString &label, int index)
{
	child->setParent(0);
