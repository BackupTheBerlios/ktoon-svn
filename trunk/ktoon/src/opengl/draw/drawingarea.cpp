...
//Rotates the selected elements 90ยบ to the right
...
//Rotates the selected elements 90ยบ to the left
...
//Rotates the selected elements 180ยบ
...
void DrawingArea::slotSelectFrame()
{
	...
	//delete current_graphic; // Missing ฌฌ
	//current_graphic = 0;
