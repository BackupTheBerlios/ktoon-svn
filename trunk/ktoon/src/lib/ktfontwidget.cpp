...
// now create the actual boxes that hold the info
	...
	if( makeFrame )
	{
		page = new QGroupBox(  tr("Actual Font"), this );
		topLayout->addWidget(page);
...
void KTFontWidget::setSizeIsRelative( QButton::ToggleState relative )
{
// check or uncheck or gray out the "relative" checkbox
...
QButton::ToggleState KTFontWidget::sizeIsRelative() const
{
