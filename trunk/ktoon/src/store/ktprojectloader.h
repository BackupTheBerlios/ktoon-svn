...
class KTProjectLoader
{
    public:
    	...
    	static void createItem(int scenePosition, int layerPosition, int framePosition, int itemPosition, KTLibraryObject::Type type, const QString &xml, KTProject *project);
